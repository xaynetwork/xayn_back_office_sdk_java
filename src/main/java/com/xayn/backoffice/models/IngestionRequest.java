...
public class IngestionRequest implements Serializable {
  ...
  private List<IngestedDocument> documents = new ArrayList<>();

  public IngestionRequest() {
  }

  public IngestionRequest documents(List<IngestedDocument> documents) {
    
    this.documents = documents;
    return this;
  }

  public IngestionRequest addDocumentsItem(IngestedDocument documentsItem) {
  ...
  **/
  ...
  public List<IngestedDocument> getDocuments() {
    return documents;
  }


  public void setDocuments(List<IngestedDocument> documents) {
    this.documents = documents;
  }
   ...
   * @return the IngestionRequest instance itself
   */
  public IngestionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IngestionRequest ingestionRequest = (IngestionRequest) o;
    return Objects.equals(this.documents, ingestionRequest.documents)&&
        Objects.equals(this.additionalProperties, ingestionRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IngestionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IngestionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IngestionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IngestionRequest is not found in the empty JSON string", IngestionRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IngestionRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydocuments.size(); i++) {
        IngestedDocument.validateJsonObject(jsonArraydocuments.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IngestionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IngestionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IngestionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IngestionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<IngestionRequest>() {
           @Override
           public void write(JsonWriter out, IngestionRequest value) throws IOException {
           ...
           @Override
           public IngestionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IngestionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IngestionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IngestionRequest
  * @throws IOException if the JSON string is invalid with respect to IngestionRequest
  */
  public static IngestionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IngestionRequest.class);
  }

 /**
  * Convert an instance of IngestionRequest to an JSON string
  *
  * @return JSON string
  */
