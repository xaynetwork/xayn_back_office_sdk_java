...
public class IngestionErrorAllOf implements Serializable {
  ...
  public IngestionErrorAllOf() {
  }

  public IngestionErrorAllOf details(IngestionErrorAllOfDetails details) {
  ...
  **/
   ...
   * @return the IngestionErrorAllOf instance itself
   */
  public IngestionErrorAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IngestionErrorAllOf ingestionErrorAllOf = (IngestionErrorAllOf) o;
    return Objects.equals(this.details, ingestionErrorAllOf.details)&&
        Objects.equals(this.additionalProperties, ingestionErrorAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IngestionErrorAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IngestionErrorAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IngestionErrorAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IngestionErrorAllOf is not found in the empty JSON string", IngestionErrorAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IngestionErrorAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IngestionErrorAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IngestionErrorAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IngestionErrorAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IngestionErrorAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<IngestionErrorAllOf>() {
           @Override
           public void write(JsonWriter out, IngestionErrorAllOf value) throws IOException {
           ...
           @Override
           public IngestionErrorAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IngestionErrorAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IngestionErrorAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IngestionErrorAllOf
  * @throws IOException if the JSON string is invalid with respect to IngestionErrorAllOf
  */
  public static IngestionErrorAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IngestionErrorAllOf.class);
  }

 /**
  * Convert an instance of IngestionErrorAllOf to an JSON string
  *
  * @return JSON string
  */
