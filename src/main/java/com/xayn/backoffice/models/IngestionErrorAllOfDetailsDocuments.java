...
public class IngestionErrorAllOfDetailsDocuments implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(example = "document_id", required = true, value = "A document id can be any non-empty UTF-8 string that does not contain the null byte. It may consist of digits, Latin letters, underscores, colons, minus signs, at signs, and dots.")
